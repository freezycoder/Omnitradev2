...
def _relative_strength_fields(result: TickerAnalysis) -> dict[str, Any]:
    ...
    return {
        ...
        "relative_strength_lifecycle": view.lifecycle_label,
        "relative_strength_lifecycle_stage": view.lifecycle_stage,
...
def _earnings_intelligence_fields(result: TickerAnalysis) -> dict[str, Any]:
    ...
    return {
        ...
        "earnings_intelligence_lifecycle": view.lifecycle_label,
        "earnings_intelligence_lifecycle_stage": view.lifecycle_stage,
