#!/usr/bin/env python3
"""Build the shadow NFCI panel and run the frozen nested-gate eval.
...
from application.nfci_regime_eval_service import NfciRegimeEvalService
from config.nfci_regime import ICE_REDISTRIBUTION_NOTICE
from providers.macro.nfci_client import NfciClient
...
def main() -> int:
    ...
    client = NfciClient(allow_public_csv=not args.no_public_csv)
    ...
    payload: dict[str, Any] = NfciRegimeEvalService().evaluate_bundle(
        bundle,
